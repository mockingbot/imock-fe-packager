...
import { binary as formatBinary, formatPadTable, stringIndentLine } from 'dr-js/module/common/format'
...
const doList = async (AWSInstance) => {
  ...
  console.log(`[List]\n${stringIndentLine(formatPadTable({ table: listOutputTable, cellPad: ' | ', padFuncList }), '  ')}`)
}
